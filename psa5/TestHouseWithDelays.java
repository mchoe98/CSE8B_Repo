...
public class TestHouseWithDelays extends ActiveObject
{
  ...
  public void run()
  {
    ...
    roof.draw( canvas, null, false );		// black outline of roof
    pause( DELAY );
    ...
    while ( p3.getY() != p1.getY() )
    {
      ...
      roofFill.draw( canvas, Color.GREEN, false );
      pause( DELAY/10 );
    
      text.setText( "Filling in the roof - " + roofFill );
    }

    roof.draw( canvas, null, false );	// draw the black roof outline
